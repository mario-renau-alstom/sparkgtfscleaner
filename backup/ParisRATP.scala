...
class ParisRATP {
 ...
 def Process(workPath: String, backupPath: String, sourcesPath: String, rawPath: String, urlfile: String, geoJsonPath: List[(String,String)], spark: SparkSession) = {
   ...
   IOOperations.ExtractFiles(urlfile, "ratp_gtfs", workPath, backupPath, sourcesPath, spark)

   var dataframes = FixOperations(sourcesPath, "ratp_gtfs", spark)
   ...
   println("Start Export data from GeoJson Providers")
   dataframes = GTFSMethods.ExportGTFSFromGeoJson(dataframes,spark)
   println("Finish Export data from GeoJson Providers")
  ...
  def FixOperations(sourcesPath: String, fileName: String, spark: SparkSession) : List[DataFrame] = {
    ...
    println("Start Update Direction")
    val trips_newDF = UpdateDirections(trips,stop_times,spark)
    println("Finish Update Direction")
    println("")
    ...
    dataframes += (routes_newDF,stops_newDF,trips_newDF,stop_times,agency,calendar_dates,calendar,transfers,stop_extensions)

    dataframes.toList

  }

  def UpdateDirections(trips: DataFrame, stop_times: DataFrame, spark: SparkSession) : DataFrame = {

    import spark.implicits._

    val toInsert = Seq(("800:H","StopPoint:8716478:800:H","StopPoint:8727646:800:H","0"),
      ("800:H","StopPoint:8727103:800:H","StopPoint:8727605:800:H","0"),
      ("800:H","StopPoint:8727103:800:H","StopPoint:8727608:800:H","0"),
      ("800:H","StopPoint:8727103:800:H","StopPoint:8727613:800:H","0"),
      ("800:H","StopPoint:8727103:800:H","StopPoint:8727638:800:H","0"),
      ("800:H","StopPoint:8727103:800:H","StopPoint:8727646:800:H","0"),
      ("800:H","StopPoint:8727103:800:H","StopPoint:8727649:800:H","0"),
      ("800:H","StopPoint:8727103:800:H","StopPoint:8727653:800:H","0"),
      ("800:H","StopPoint:8727103:800:H","StopPoint:8727657:800:H","0"),
      ("800:H","StopPoint:8727103:800:H","StopPoint:8727660:800:H","0"),
      ("800:H","StopPoint:8727600:800:H","StopPoint:8727613:800:H","1"),
      ("800:H","StopPoint:8727600:800:H","StopPoint:8727646:800:H","1"),
      ("800:H","StopPoint:8727605:800:H","StopPoint:8711300:800:H","1"),
      ("800:H","StopPoint:8727605:800:H","StopPoint:8727103:800:H","1"),
      ("800:H","StopPoint:8727605:800:H","StopPoint:8727613:800:H","0"),
      ("800:H","StopPoint:8727605:800:H","StopPoint:8727646:800:H","0"),
      ("800:H","StopPoint:8727605:800:H","StopPoint:8727663:800:H","0"),
      ("800:H","StopPoint:8727613:800:H","StopPoint:8711300:800:H","1"),
      ("800:H","StopPoint:8727613:800:H","StopPoint:8727103:800:H","1"),
      ("800:H","StopPoint:8727613:800:H","StopPoint:8727600:800:H","0"),
      ("800:H","StopPoint:8727613:800:H","StopPoint:8727605:800:H","1"),
      ("800:H","StopPoint:8727613:800:H","StopPoint:8727646:800:H","0"),
      ("800:H","StopPoint:8727638:800:H","StopPoint:8711300:800:H","1"),
      ("800:H","StopPoint:8727638:800:H","StopPoint:8727103:800:H","1"),
      ("800:H","StopPoint:8727638:800:H","StopPoint:8727646:800:H","0"),
      ("800:H","StopPoint:8727638:800:H","StopPoint:8727657:800:H","0"),
      ("800:J","StopPoint:8738400:800:J","StopPoint:8753413:800:J","0"),
      ("800:J","StopPoint:8738640:800:J","StopPoint:8738150:800:J","0"),
      ("800:J","StopPoint:8738641:800:J","StopPoint:8738150:800:J","0"),
      ("800:J","StopPoint:8738641:800:J","StopPoint:8738668:800:J","0"),
      ("800:J","StopPoint:8738657:800:J","StopPoint:8738150:800:J","0"),
      ("800:J","StopPoint:8738657:800:J","StopPoint:8738668:800:J","0"),
      ("800:J","StopPoint:8738668:800:J","StopPoint:8738150:800:J","0"),
      ("800:J","StopPoint:8738668:800:J","StopPoint:8738189:800:J","1"),
      ("800:J","StopPoint:8738668:800:J","StopPoint:8738400:800:J","1"),
      ("800:J","StopPoint:8741560:800:J","StopPoint:8738400:800:J","1"),
      ("800:J","StopPoint:8753413:800:J","StopPoint:8738400:800:J","1")).
      toDF("route_id","stop_id_init","stop_id_last", "direction_id")

    // Window Functions
    val wLast = Window.partitionBy("trip_id").orderBy("stop_sequence").rowsBetween(Window.currentRow, Window.unboundedFollowing)
    val wInit = Window.partitionBy("trip_id").orderBy("stop_sequence")

    val main_update_filtered = trips.join(stop_times,"trip_id").distinct().
      withColumn("stop_sequence", 'stop_sequence.cast("int")).
      orderBy("route_id","direction_id","trip_id","stop_sequence").
      select("route_id","service_id","trip_id","trip_headsign","trip_short_name","block_id",
        "wheelchair_accessible","bikes_allowed","trip_desc","shape_id","stop_id","stop_sequence").
      withColumn("stop_id_init", first("stop_id").over(wInit)).
      withColumn("stop_id_last", last("stop_id").over(wLast)).
      select("route_id","service_id","trip_id","trip_headsign","trip_short_name","block_id",
        "wheelchair_accessible","bikes_allowed","trip_desc","shape_id","stop_id_init","stop_id_last").distinct()

    val tripstoUpdate = main_update_filtered.join(toInsert, Seq("route_id","stop_id_init","stop_id_last")).
      select("route_id","service_id","trip_id","trip_headsign","trip_short_name","direction_id","block_id",
        "wheelchair_accessible","bikes_allowed","trip_desc","shape_id")
    val tripsUpdated = trips.alias("tripsDF").join(tripstoUpdate.alias("tripstoUpdate"),
      Seq("trip_id","route_id","service_id","trip_headsign","trip_short_name","wheelchair_accessible","bikes_allowed"),"leftouter").
      where($"tripstoUpdate.direction_id".isNull).drop($"tripstoUpdate.block_id").
      drop($"tripstoUpdate.trip_desc").drop($"tripstoUpdate.shape_id").drop($"tripstoUpdate.direction_id").
      select("route_id","service_id","trip_id","trip_headsign","trip_short_name","direction_id","block_id",
        "wheelchair_accessible","bikes_allowed","trip_desc","shape_id").union(tripstoUpdate).
      select("route_id","service_id","trip_id","trip_headsign","trip_short_name","direction_id","block_id",
        "wheelchair_accessible","bikes_allowed","trip_desc","shape_id")
  ...
  def UploadAzure(dataframes: List[DataFrame], rawPath: String, spark: SparkSession) = {
    ...
    val raw_path = rawPath.concat("GTFSCLEAN/" + "ratp_gtfs/")
    val routes = dataframes(0)
    val stops = dataframes(1)
    val trips = dataframes(2)
    val stop_times = dataframes(3)
    ...
    stop_extensions.write.mode("overwrite").parquet(raw_path + "stop_extensions.parquet")
